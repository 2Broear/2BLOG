    <title><?php global $src_cdn, $img_cdn; $cat = $cat ? $cat : get_page_cat_id(current_slug()); $set=get_term_meta($cat, 'seo_title', true);echo $set ? $set : custom_title(); ?></title>
    ...
    <meta name="msapplication-TileImage" content="<?php $site_favico = get_site_icon_url() ? get_site_icon_url() : $img_cdn.'/images/favicon/favicon.ico';echo $site_favico; ?>" />
    ...
    <style>
        body.dark #supports em.warmhole{
            filter: invert(1);
            /*background: url(<?php echo $img_cdn; ?>/images/wormhole_2_tp.gif) no-repeat center center /cover!important;*/
        }
        <?php 
...
?>
        ...
        <script>
            ...
            // asyncLoad('<?php echo $src_cdn; ?>/js/leancloud/av-min.js?v=headcall', function(){
                AV.init({

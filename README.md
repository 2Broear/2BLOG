...
### 主题文档
首先说明一下，这款主题完全是处于我当前的职业形势下开发完成的，并不能保证适用所有人（之前还鸽了HEXO的主题开发，主要是文档太难找了），开源一方面是因为之前静态博客内容多了之后不好管理的问题（后来甚至做了个markdown的编辑器，不过没用就是了），另外也是因为之前得到了部分博友的认可，都有意向使用这个主题，那么正巧公司的框架去年也搬到wp了所以整个开发流程是相对顺利的，所有功能在主题之间都能通用这一点还是很友好的。

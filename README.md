...
=======
__Preview Site__ ：[演示站点](http://wps.2broear.com) （演示并不代表最终版本，最新请以 [blog.2broear.com](http://blog.2broear.com) 为准）
>>>>>>> e363427c74d4d4fbca96aacc0965d99a68c5832b
...
=======
如需实现 [演示站](http://wps.2broear.com) 的 _permalink/url_ 层级（404等预设页面也需要配置伪静态后才能访问）需配置如下两项：
>>>>>>> e363427c74d4d4fbca96aacc0965d99a68c5832b

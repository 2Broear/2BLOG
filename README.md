...
__Preview Site__ ：[演示站点](http://wp.2broear.com) （演示并不代表最终版本，最新请以 [blog.2broear.com](http://blog.2broear.com) 为准）
...
伪静态与固定链接
--------------------------------------------------------------------------------------------------------------------------------------------------------------------
如需实现 [演示站](http://wp.2broear.com) 的 _permalink/url_ 层级（404等预设页面也需要配置伪静态后才能访问）需配置如下两项：

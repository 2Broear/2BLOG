...
<div class="content-all">
    <div class="win-top bg">
        ...
        <video src="<?php echo $pvideo = get_option('site_privacy_video'); ?>" poster="<?php echo $pvideo ? $pvideo : cat_metabg($cat, custom_cdn_src('img',true).'/images/privacy.jpg'); ?>" preload autoplay muted loop x5-video-player-type="h5" controlsList="nofullscreen nodownload"></video>
...
<script>
    setVideoPoster(1,0.5,true); // 截取设置当前页面所有视频 poster 
</script>
</body></html>
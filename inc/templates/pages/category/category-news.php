					...
					<div class="news-article-list p1">
                        <?php
                            ...
                            if(!$left_query->have_posts()){
                                echo '<div class="empty_card magnetic" data-magnet-scale="1" data-magnet-step=""><i class="icomoon icom icon-'.current_slug().'" data-t="'.current_slug().'"></i><h1> <b>>_∩</b>0ρ0st </h1></div>';  //<b>'.current_slug(true).'</b> 
                            }

...
<head>
    ...
    <style>
        ...
        .friends-boxes .deals .inboxSliderCard .slideBox a:hover {
        ...
        /*    margin-right: 15px;*/
        /*}*/
        /*.friends-boxes .deals .inbox.standby:hover > .inbox-inside {*/
        /*    transform: none;*/
        /*}*/
        /*body.dark .friends-boxes .deals .inbox.standby .inbox-inside::before {*/
        /*    background-color:var(--preset-2b);*/
        /*}*/
        /*.friends-boxes .deals .inbox.standby::before {*/
        /*    border-radius: inherit;*/
        /*}*/
        /*.friends-boxes .deals .inbox.standby {*/
        /*    z-index: 0;*/
        /*}*/
        .friends-boxes .deals .inbox.standby .inbox-inside.aside {
            display: none;
        }
        .friends-boxes .deals .inbox.standby:hover .inbox-inside {
            pointer-events: auto;
        ...
        .friends-boxes .deals .inbox.standby .inbox-inside {
        	box-shadow: none;
            background: none !important;
            pointer-events: none;
            opacity: .55;
        }
        .friends-boxes .deals .inbox.standby .inbox-inside::before {
        	/*content: none;*/
        	opacity: .15;
        }
        ...
        .friends-boxes .deals .inbox .inbox-inside {
            will-change: auto;
        }
...
<!-- siteJs -->
<?php
    if (get_option('site_links_auto_slider')) {
?>
    <script type="module">
        try {
            import("<?php echo custom_cdn_src(0,1);//$src_cdn; ?>/js/slidebox.js").then((mod)=> {
                const { AutoSlideBox, Utils } = mod;
...
<script type="text/javascript">
    bindEventClick(document.querySelector('.friends-boxes'), '', (t, e)=> {

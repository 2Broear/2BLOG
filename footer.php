      ...
      <div id="footer-copyright">
        <span class="what_says">
          ...
          <ul style="text-align:right">
              ...
              ?>
              <p style="margin:auto;opacity:.75;font-size:12px;font-style:italic"> WordPress Theme <a href="//github.com/2Broear/2BLOG" style="color:inherit;" target="_blank"><b>2BLOG</b></a> open sourced via 2broear </p>
          </ul>
        </span>
      </div>
    </div>

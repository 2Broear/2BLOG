          ...
          <ul style="text-align:left">
            ...
            <p id="supports">
                <?php 
                    ...
                    echo '<a href="javascript:;" target="" rel="nofollow"><img class="magnetics" data-magnet-scale="1" data-magnet-step="" src="'.$img_cdn.'/images/svg/SpaceX.svg" alt="SpaceX" style="height: 10px;filter:invert(0.5);margin-left:5px;"></a>';

          ...
          <div class="footer-contact-left">
            ...
            <div class="footer-right">
              <ul class="footer-contact">
                <h2>找到我</h2>
                <li class="contactBox">
                    <a href="<?php bloginfo('rss2_url'); ?>" target="_blank" rel="nofollow" aria-label="rss">
                        <span class="contact-icons" id="icon-rss">
                            <i class="icom"></i>
                        </span>
                    </a>
                    <?php
                            ...
                            <script type="text/javascript"> //addAscending createdAt
                                new AV.Query("link").addDescending("updatedAt").equalTo('sitelink', 'true').find().then(result=>{
                                    for (let i=0,resLen=result.length; i<resLen;i++) {
                                        document.querySelector(".friend_links li.friendsBox").innerHTML += `<a href="${result[i].attributes.link}" class="inbox-aside magnetic" data-magnet-scale="1" target="_blank" rel="sitelink">${result[i].attributes.name}</a>`;
                                    };
                                })
                            </script>
                    <?php
            ...
            <p id="supports">
                <?php 
                    ...
                    if(get_option('site_foreverblog_switcher')){
                        echo '<a href="'.get_option('site_foreverblog').'" target="_blank" rel="nofollow"><img src="'.$img_cdn.'/images/svg/foreverblog.svg" class="magnetics" data-magnet-scale="1" data-magnet-step="" alt="foreverblog" style="height: 16px;"></a>';
                        if(get_option('site_foreverblog_wormhole')){
                            // $theme = array_key_exists('theme_mode',$_COOKIE) ? $_COOKIE['theme_mode'] : false;
                            echo '<a href="//www.foreverblog.cn/go.html" target="_blank" rel="nofollow"><em class="warmhole magnetics" data-magnet-scale="1" data-magnet-step="" style="background:url('.$img_cdn.'/images/wormhole_4_tp_ez.gif) no-repeat center center /cover" title="穿梭虫洞-随机访问十年之约友链博客"></em></a>';
                        }
                    }
                    if($moe_beian && get_option('site_moe_beian_travel')) echo '<a href="//travel.moe/go.html" target="_blank" rel="nofollow"><img src="//moe.one/upload/attach/202307/89_8TEYVRKUCP79XHG.png" class="magnetics" data-magnet-scale="1" data-magnet-step="" alt="moe_beian" title="异次元之旅-跃迁" style=""></a>';
                    ...
                    echo '<a href="javascript:;" target="" rel="nofollow"><img class="magnetics" data-magnet-scale="1" data-magnet-step="" src="'.$img_cdn.'/images/svg/deepal-blue.svg" alt="deepal-blue" style="height: 14px;filter:invert(0.5);"></a>';
                    echo '<a href="//spacex.com" target="_blank" rel="nofollow"><img class="magnetics" data-magnet-scale="1" data-magnet-step="" src="'.$img_cdn.'/images/svg/SpaceX.svg" alt="SpaceX" style="height: 10px;filter:invert(0.5);margin-left:5px;"></a>';

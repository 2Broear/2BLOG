                    ...
                    <tr valign="top" class="">
                        ...
                        <td>
                            <?php
                                ...
                                $preset = 5;  //默认填充数据
                                if(!$value) update_option($opt, $preset);else $preset=$value;  //auto update option to default if unset
                                echo '<p class="description" id="">应用于近期评论、排行等<b> 无需分页 </b>内容展示数量（默认 5，此项不应用于 <code>posts_per_page</code> 查询参数，<b>可能造成分页 404</b></p><input type="number" max="" min="1" name="'.$opt.'" id="'.$opt.'" class="small-text" value="' . $preset . '"/>';
                            ?>
                        </td>
                    </tr>
                    <tr valign="top">
